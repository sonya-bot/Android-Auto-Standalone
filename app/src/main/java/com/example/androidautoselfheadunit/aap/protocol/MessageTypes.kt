...
object MessageTypes {
    ...
    fun name(
        ...
        when (type) {
            ...
            0 -> return "Media Data"
            1 -> return "Codec Config"
            32768 -> return "Media Setup Request"
            32769 -> {
                return when (channel) {
            ...
            32772 -> return "Codec/Media Data Ack"
            32773 -> return "Mic Start/Stop Request"
            32774 -> return "Mic Response"
            32775 -> return "Video Focus Request"
            32776 -> return "Video Focus Notification"
            32777 -> return "Update UI Config Request"
            32778 -> return "Update UI Config Reply"
            32779 -> return "Audio Underflow Notification"
