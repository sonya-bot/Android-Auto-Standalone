...
| [`07_keyboard_dpi_optimization_plan.md`](./07_keyboard_dpi_optimization_plan.md) | 改善・最適化 | キーボード表示サイズ拡大およびDPI最適化（213 DPI → 280 DPI）。解像度・2画面分割を維持したままUIとキーボードを約31%拡大 |
